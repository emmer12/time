...
(function($) {
 ...
 //faq area carousel active
  ...
  $('.bar').click(function(){
    ...
    $('.downloadAni').click(function () {  
      window.open('/assets/books/time.pdf')

    })

    $('.info').click(function () {  
         $('.details').addClass('added animated slideInUp')
    })

    $('.c').click(function () {  
      $('.details').removeClass('added animated slideOutDown')
 })


    $('#shareBlock').cShare({
      description: '',
      showButtons: ['fb','twitter','email','whatsapp']
    });
...
document.addEventListener('scroll',function () { 
  ...
  window.scrollY > 200 ? elem.addClass('added') : elem.removeClass('added');
    ...
    gsap.from('.downloadAni',1,{y:10,repeat:-1,yoyo:true})
    gsap.from('.book',5,{rotateY:18,rotate:-5,repeat:-1,yoyo:true})
